...
file_name_str = "ToDoFile.txt"  # The name of the data file - NOTE THAT A BLANK "TODOFILE.TXT" MUST BE SUPPLIED
...
class IO:
    ...
    def input_task_to_remove():
        ...
        """
        remove_task = input("Please enter name of Task to remove from list: ").strip()
        return remove_task
